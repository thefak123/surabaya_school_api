<x-app-layout>
            ...
            <ul id="tocify-header-all-surabaya-school" class="tocify-header">
                ...
                <ul id="tocify-subheader-all-surabaya-school" class="tocify-subheader">
                    ...
                    <li class="tocify-item level-2" data-unique="all-surabaya-school-GETapi-schools-name--name-">
                        <a href="#all-surabaya-school-GETapi-schools-name--name-">Display the specified school in
                            surabaya by name.</a>
                    </li>
                    <li class="tocify-item level-2"
                        data-unique="all-surabaya-school-GETapi-schools-postal--postal_code-">
                        <a href="#all-surabaya-school-GETapi-schools-postal--postal_code-">Display the specified school
                            in surabaya by postal code.</a>
                    </li>
                </ul>
            </ul>
            ...
            <ul id="tocify-header-surabaya-elementary-school" class="tocify-header">
                ...
                <ul id="tocify-subheader-surabaya-elementary-school" class="tocify-subheader">
                    <li class="tocify-item level-2" data-unique="surabaya-elementary-school-GETapi-schools-elementary">
                        <a href="#surabaya-elementary-school-GETapi-schools-elementary">Display all of elementary school
                            in surabaya.</a>
                    </li>
                    <li class="tocify-item level-2"
                        data-unique="surabaya-elementary-school-GETapi-schools-elementary--name-">
                        <a href="#surabaya-elementary-school-GETapi-schools-elementary--name-">Display the specified
                            school in surabaya by name.</a>
                    </li>
                    <li class="tocify-item level-2"
                        data-unique="surabaya-elementary-school-GETapi-schools-elementary--postal_code-">
                        <a href="#surabaya-elementary-school-GETapi-schools-elementary--postal_code-">Display the
                            specified school in surabaya by postal code.</a>
                    </li>
                </ul>
            </ul>
            <ul id="tocify-header-surabaya-junior-high-school" class="tocify-header">
                ...
                <ul id="tocify-subheader-surabaya-junior-high-school" class="tocify-subheader">
                    <li class="tocify-item level-2" data-unique="surabaya-junior-high-school-GETapi-schools-junior">
                        <a href="#surabaya-junior-high-school-GETapi-schools-junior">Display all of junior high school
                            in surabaya.</a>
                    </li>
                    <li class="tocify-item level-2"
                        data-unique="surabaya-junior-high-school-GETapi-schools-junior--name-">
                        <a href="#surabaya-junior-high-school-GETapi-schools-junior--name-">Display the specified school
                            in surabaya by name.</a>
                    </li>
                    <li class="tocify-item level-2"
                        data-unique="surabaya-junior-high-school-GETapi-schools-junior--postal_code-">
                        <a href="#surabaya-junior-high-school-GETapi-schools-junior--postal_code-">Display the specified
                            school in surabaya by postal code.</a>
                    </li>
                </ul>
            </ul>
            <ul id="tocify-header-surabaya-senior-high-school" class="tocify-header">
                ...
                <ul id="tocify-subheader-surabaya-senior-high-school" class="tocify-subheader">
                    <li class="tocify-item level-2" data-unique="surabaya-senior-high-school-GETapi-schools-senior">
                        <a href="#surabaya-senior-high-school-GETapi-schools-senior">Display all of Senior High School
                            in surabaya.</a>
                    </li>
                    <li class="tocify-item level-2"
                        data-unique="surabaya-senior-high-school-GETapi-schools-senior--name-">
                        <a href="#surabaya-senior-high-school-GETapi-schools-senior--name-">Display the specified
                            school in surabaya by name.</a>
                    </li>
                    <li class="tocify-item level-2"
                        data-unique="surabaya-senior-high-school-GETapi-schools-senior--postal_code-">
                        <a href="#surabaya-senior-high-school-GETapi-schools-senior--postal_code-">Display the
                            specified school in surabaya by postal code.</a>
                    </li>
                </ul>
            </ul>
    ...
    <div class="page-wrapper">
        ...
        <div class="content">
            ...
            <p>To authenticate requests, include a <strong><code>Api-Key</code></strong> header with the value
                <strong><code>"{YOUR_AUTH_KEY}"</code></strong>.</p>
    ...
    &quot;data&quot;: [
        ...
        },
        {
            ...
            <span id="execution-results-GETapi-schools" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-schools"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-schools" data-method="GET" data-path="api/schools" data-authed="1"
                ...
                <h3>
                    ...
                    <button type="button"
                        ...
                        id="btn-tryout-GETapi-schools" onclick="tryItOut('GETapi-schools');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-schools" onclick="cancelTryOut('GETapi-schools');" hidden>Cancel
                        🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-schools" data-initial-text="Send Request 💥"
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Api-Key" class="auth-value"
                        data-endpoint="GETapi-schools" value="{YOUR_AUTH_KEY}" data-component="header">
                    <br>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="GETapi-schools"
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-schools"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
            ...
            <h2 id="all-surabaya-school-GETapi-schools-name--name-">Display the specified school in surabaya by name.
            </h2>
    ...
    &quot;data&quot;: {
        ...
        &quot;phone_number&quot;: 2131231231
            ...
            <span id="execution-results-GETapi-schools-name--name-" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-schools-name--name-"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-schools-name--name-" data-method="GET" data-path="api/schools/name/{name}"
                ...
                <h3>
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-schools-name--name-" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Api-Key" class="auth-value"
                        data-endpoint="GETapi-schools-name--name-" value="{YOUR_AUTH_KEY}" data-component="header">
                    <br>
                    <p>Example: <code>{YOUR_AUTH_KEY}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="GETapi-schools-name--name-" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    <input type="text" style="display: none" name="name"
                        data-endpoint="GETapi-schools-name--name-" value="sekolah citra berkat" data-component="url">
                    <br>
                    <p>The school name. Example: <code>sekolah citra berkat</code></p>
                </div>
            </form>

            <h2 id="all-surabaya-school-GETapi-schools-postal--postal_code-">Display the specified school in surabaya
                by postal code.</h2>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-schools-postal--postal_code-" data-method="GET"
                data-path="api/schools/postal/{postal_code}" data-authed="1" data-hasfiles="0" data-isarraybody="0"
                autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-schools-postal--postal_code-" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Api-Key" class="auth-value"
                        data-endpoint="GETapi-schools-postal--postal_code-" value="{YOUR_AUTH_KEY}"
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="GETapi-schools-postal--postal_code-" value="application/json"
                        data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    <small>integer</small>&nbsp;
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="postal_code"
                        data-endpoint="GETapi-schools-postal--postal_code-" value="22312" data-component="url">
                    <br>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <h2 id="surabaya-elementary-school-GETapi-schools-elementary">Display all of elementary school in surabaya.
            </h2>
    ...
    &quot;data&quot;: [
        {
            ...
            <span id="execution-results-GETapi-schools-elementary" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-schools-elementary"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-schools-elementary" data-method="GET" data-path="api/schools/elementary"
                data-authed="1" data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-schools-elementary" onclick="tryItOut('GETapi-schools-elementary');">Try
                        it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-schools-elementary" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Api-Key" class="auth-value"
                        data-endpoint="GETapi-schools-elementary" value="{YOUR_AUTH_KEY}" data-component="header">
                    <br>
                    <p>Example: <code>{YOUR_AUTH_KEY}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="GETapi-schools-elementary" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
            ...
            <h2 id="surabaya-elementary-school-GETapi-schools-elementary--name-">Display the specified school in
                surabaya by name.</h2>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-schools-elementary--name-" data-method="GET"
                data-path="api/schools/elementary/{name}" data-authed="1" data-hasfiles="0" data-isarraybody="0"
                autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-schools-elementary--name-" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Api-Key" class="auth-value"
                        data-endpoint="GETapi-schools-elementary--name-" value="{YOUR_AUTH_KEY}"
                        data-component="header">
                    <br>
                    <p>Example: <code>{YOUR_AUTH_KEY}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="GETapi-schools-elementary--name-" value="application/json"
                        data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="name"
                        data-endpoint="GETapi-schools-elementary--name-" value="sekolah citra berkat"
                        data-component="url">
                    <br>
                    <p>The school name. Example: <code>sekolah citra berkat</code></p>
                </div>
            ...
            <h2 id="surabaya-elementary-school-GETapi-schools-elementary--postal_code-">Display the specified school in
                surabaya by postal code.</h2>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-schools-elementary--postal_code-" data-method="GET"
                data-path="api/schools/elementary/{postal_code}" data-authed="1" data-hasfiles="0"
                data-isarraybody="0" autocomplete="off"
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Api-Key" class="auth-value"
                        data-endpoint="GETapi-schools-elementary--postal_code-" value="{YOUR_AUTH_KEY}"
                        data-component="header">
                    <br>
                    <p>Example: <code>{YOUR_AUTH_KEY}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="GETapi-schools-elementary--postal_code-" value="application/json"
                        data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="postal_code"
                        data-endpoint="GETapi-schools-elementary--postal_code-" value="22312" data-component="url">
                    <br>
                    <p>The school name. Example: <code>22312</code></p>
                </div>
            </form>
            ...
            <h2 id="surabaya-junior-high-school-GETapi-schools-junior">Display all of junior high school in surabaya.
            </h2>
    ...
    &quot;data&quot;: [
        {
            ...
            <span id="execution-results-GETapi-schools-junior" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-schools-junior"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-schools-junior" data-method="GET" data-path="api/schools/junior" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-schools-junior" onclick="tryItOut('GETapi-schools-junior');">Try it out
                        ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-schools-junior" onclick="cancelTryOut('GETapi-schools-junior');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-schools-junior" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Api-Key" class="auth-value"
                        data-endpoint="GETapi-schools-junior" value="{YOUR_AUTH_KEY}" data-component="header">
                    <br>
                    <p>Example: <code>{YOUR_AUTH_KEY}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="GETapi-schools-junior" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-schools-junior"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
            ...
            <h2 id="surabaya-junior-high-school-GETapi-schools-junior--name-">Display the specified school in surabaya
                by name.</h2>
    ...
    &quot;data&quot;: {
        ...
        &quot;phone_number&quot;: 2131231231
            ...
            <span id="execution-results-GETapi-schools-junior--name-" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-schools-junior--name-"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-schools-junior--name-" data-method="GET" data-path="api/schools/junior/{name}"
                data-authed="1" data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-schools-junior--name-" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Api-Key" class="auth-value"
                        data-endpoint="GETapi-schools-junior--name-" value="{YOUR_AUTH_KEY}" data-component="header">
                    <br>
                    <p>Example: <code>{YOUR_AUTH_KEY}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="GETapi-schools-junior--name-" value="application/json"
                        data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="name"
                        data-endpoint="GETapi-schools-junior--name-" value="sekolah citra berkat"
                        data-component="url">
                    <br>
                    <p>The school name. Example: <code>sekolah citra berkat</code></p>
                </div>
            ...
            <h2 id="surabaya-junior-high-school-GETapi-schools-junior--postal_code-">Display the specified school in
                surabaya by postal code.</h2>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-schools-junior--postal_code-" data-method="GET"
                data-path="api/schools/junior/{postal_code}" data-authed="1" data-hasfiles="0" data-isarraybody="0"
                autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-schools-junior--postal_code-" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Api-Key" class="auth-value"
                        data-endpoint="GETapi-schools-junior--postal_code-" value="{YOUR_AUTH_KEY}"
                        data-component="header">
                    <br>
                    <p>Example: <code>{YOUR_AUTH_KEY}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="GETapi-schools-junior--postal_code-" value="application/json"
                        data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="postal_code"
                        data-endpoint="GETapi-schools-junior--postal_code-" value="22312" data-component="url">
                    <br>
                    <p>The school name. Example: <code>22312</code></p>
                </div>
            </form>
            ...
            <h2 id="surabaya-senior-high-school-GETapi-schools-senior">Display all of Senior High School in surabaya.
            </h2>
    ...
    &quot;data&quot;: [
        {
            ...
            <span id="execution-results-GETapi-schools-senior" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-schools-senior"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-schools-senior" data-method="GET" data-path="api/schools/senior" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-schools-senior" onclick="tryItOut('GETapi-schools-senior');">Try it out
                        ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-schools-senior" onclick="cancelTryOut('GETapi-schools-senior');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-schools-senior" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Api-Key" class="auth-value"
                        data-endpoint="GETapi-schools-senior" value="{YOUR_AUTH_KEY}" data-component="header">
                    <br>
                    <p>Example: <code>{YOUR_AUTH_KEY}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="GETapi-schools-senior" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-schools-senior"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
            ...
            <h2 id="surabaya-senior-high-school-GETapi-schools-senior--name-">Display the specified school in surabaya
                by name.</h2>
    ...
    &quot;data&quot;: {
        ...
        &quot;phone_number&quot;: 2131231231
            ...
            <span id="execution-results-GETapi-schools-senior--name-" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-schools-senior--name-"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-schools-senior--name-" data-method="GET" data-path="api/schools/senior/{name}"
                data-authed="1" data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-schools-senior--name-" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Api-Key" class="auth-value"
                        data-endpoint="GETapi-schools-senior--name-" value="{YOUR_AUTH_KEY}" data-component="header">
                    <br>
                    <p>Example: <code>{YOUR_AUTH_KEY}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="GETapi-schools-senior--name-" value="application/json"
                        data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="name"
                        data-endpoint="GETapi-schools-senior--name-" value="sekolah citra berkat"
                        data-component="url">
                    <br>
                    <p>The school name. Example: <code>sekolah citra berkat</code></p>
                </div>
            ...
            <h2 id="surabaya-senior-high-school-GETapi-schools-senior--postal_code-">Display the specified school in
                surabaya by postal code.</h2>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-schools-senior--postal_code-" data-method="GET"
                data-path="api/schools/senior/{postal_code}" data-authed="1" data-hasfiles="0"
                data-isarraybody="0" autocomplete="off"
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Api-Key" class="auth-value"
                        data-endpoint="GETapi-schools-senior--postal_code-" value="{YOUR_AUTH_KEY}"
                        data-component="header">
                    <br>
                    <p>Example: <code>{YOUR_AUTH_KEY}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="GETapi-schools-senior--postal_code-" value="application/json"
                        data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="postal_code"
                        data-endpoint="GETapi-schools-senior--postal_code-" value="22312" data-component="url">
                    <br>
                    <p>The school name. Example: <code>22312</code></p>
                </div>
            </form>
