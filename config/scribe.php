...
return [
    ...
    'intro_text' => <<<INTRO
This documentation aims to provide all the information you need to work with our API. In order to be working, you need API KEY, which is provided inside profile section
